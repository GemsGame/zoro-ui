...
import {
  QueryClientProvider as QueryClientProviderRainbow,
  QueryClient as QueryRainbow,
...
const queryRainbow = new QueryRainbow();
...
const App = () => (
  <WagmiProvider config={config}>
    <QueryClientProviderRainbow client={queryRainbow}>
      <RainbowKitProvider>
